...
export class ModalPayCard {
	  ...
	  constructor(public viewCtrl: ViewController, public alertCtrl: AlertController, private api: ApiDataService, public app: App, public navCtrl: NavController, private dataUpdateService:DataUpdateService, public translate: TranslateService ) {
